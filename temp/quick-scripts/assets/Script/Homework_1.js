(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Homework_1.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '26500CvPwxHRJQlkMjk2eKO', 'Homework_1', __filename);
// Script/Homework_1.js
...
cc.Class({
    ...
    validateUser: function validateUser(str) {
        var format = /[ `!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/;
        if (format.test(str)) {
    ...
    checkPassLength: function checkPassLength(str) {
        var format = /[ `!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/;
        var lower = /[a-z]/;
        var upper = /[A-Z]/;
        var number = /[0-9]/;
    ...
    signupClicked: function signupClicked() {
        ...
        var string = '<color=#000000>Welcome</c> <u><color = FF0000>' + this.userName.textLabel.string + '</c></u>' + ' <color=#000000>join this club at</c> <i><color = FFFF00>' + hour + ':' + minutes + ':' + seconds + '</c></i>';
    ...
    addScrollView: function addScrollView(data) {
